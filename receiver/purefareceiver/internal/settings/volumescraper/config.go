...
// Config relating to Volume Metric Scraper.
type Config struct {
	Metrics metadata.MetricsSettings `mapstructure:"metrics"`
	// Include specifies a filter on the pod interfaces that should be included from the generated metrics.
	Include MatchConfig `mapstructure:"include"`
	// Exclude specifies a filter on the pod interfaces that should be excluded from the generated metrics.
