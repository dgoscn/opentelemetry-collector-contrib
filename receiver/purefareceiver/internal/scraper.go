...
const (
	EmitMetricsWithDirectionAttributeFeatureGateID    = "receiver.purefareceiver.emitMetricsWithDirectionAttribute"
	EmitMetricsWithoutDirectionAttributeFeatureGateID = "receiver.purefareceiver.emitMetricsWithoutDirectionAttribute"
)
...
var (
	emitMetricsWithDirectionAttributeFeatureGate = featuregate.Gate{
		...
		Description: "Some process host metrics reported are transitioning from being reported with a direction " +
			...
			"https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/purefareceiver/README.md#feature-gate-configurations",
	}
